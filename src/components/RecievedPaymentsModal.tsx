...
const RecievedPaymentsModal = (props: Props) => {
    ...
    return (
        <>
            <Button bg={"#0d9488"} width={{ base: '100%', sm: '100%' }} onClick={onOpen}>Claim payments</Button>
                                ...
                                <Tbody>
                                    {props.payments.map((payment: any, index) => {
                                        return <Tr key={index}>
                                            ...
                                            <Td><Button isDisabled={payment.claimed} onClick={() => { claimPayment(payment.payment_id) }}>Claim</Button></Td>
                                        </Tr>
                                    })}
                                </Tbody>
                            </Table>
